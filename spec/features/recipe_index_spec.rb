...
RSpec.feature 'Foods', type: :feature do
    ...
    scenario 'User views the list of recipes' do
        ...
        recipe1 = Recipe.create(name: 'Recipe 1', preparation_time: 30, cooking_time: 60, description: 'Description 1', public: true, user: User.first)
        recipe2 = Recipe.create(name: 'Recipe 2', preparation_time: 45, cooking_time: 90, description: 'Description 2', public: true, user: User.first)
