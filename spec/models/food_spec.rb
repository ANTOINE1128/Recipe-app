...
RSpec.describe Food, type: :model do
  ...
  it 'updates quantity based on associated recipe_foods' do
    recipe = Recipe.create(name: 'Recipe 1', user:)
    food = Food.create(name: 'Apple', measurement_unit: 'grams', price: 0.5, quantity: 0, user:)
    RecipeFood.create(food:, recipe:, quantity: 10)
